...
import { MoreVert, ChatBubbleOutline, DeleteOutline } from "@mui/icons-material"
    ...
    return (
        <div className='post'>
            ...
            <div className="postDetails">
                ...
                <Typography fontWeight={100} color="rgba(0, 0, 0, 582)" style={{ alignSelf: "center" }}>{caption}</Typography>
            </div>
